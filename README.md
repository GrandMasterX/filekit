[![Packagist](https://img.shields.io/packagist/dt/grandmasterx/yii2-file-kit.svg)]()
[![Dependency Status](https://www.versioneye.com/php/grandmasterx:yii2-file-kit/badge.svg)](https://www.versioneye.com/php/grandmasterx:yii2-file-kit/2.0.0)
...
Demo
----
Since file kit is a part of [yii2-starter-kit](https://github.com/grandmasterx/yii2-starter-kit) it's demo can be found in starter kit demo [here](http://backend.yii2-starter-kit.terentev.net/article/create).
...
```php
'fileStorage'=>[
    'class' => 'grandmasterx\filekit\Storage',
    'baseUrl' => '@web/uploads'
    'filesystem'=> ...
        // OR
    'filesystemComponent' => ...    
...
```
There are several ways to configure `grandmasterx\filekit\Storage` to work with `flysystem`.
...
- Create a builder class that implements `grandmasterx\filekit\filesystem\FilesystemBuilderInterface` and implement method `build` which returns filesystem object. See ``examples/``
...
public function actions(){
    return [
           'upload'=>[
               'class'=>'grandmasterx\filekit\actions\UploadAction',
...
public function actions(){
    return [
       'delete'=>[
           'class'=>'grandmasterx\filekit\actions\DeleteAction',
...
public function actions(){
    return [
       'view'=>[
           'class'=>'grandmasterx\filekit\actions\ViewAction',
       ]
    ];
}
```
...
Standalone usage
```php
echo \grandmasterx\filekit\widget\Upload::widget([
    'model' => $model,
    'attribute' => 'files',
    'url' => ['upload'],
    'sortable' => true,
...
echo $form->field($model, 'files')->widget(
    '\grandmasterx\filekit\widget\Upload',
    [
        'url' => ['upload'],
        'sortable' => true,
...
```php
 public function behaviors()
 {
    return [
        'file' => [
            'class' => 'grandmasterx\filekit\behaviors\UploadBehavior',
